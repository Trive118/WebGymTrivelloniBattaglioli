...
public interface IService
{
	...
	[OperationContract]
	List<EsercizioDTO>GetAllExercise();

	[OperationContract]
	bool AddExerciseToCardGym(string descrizione_esercizio,int id_scheda, int num_ripetizioni, TimeSpan tempo_recupero, string commento);

	[OperationContract]
	List<UserDTO> OttieniListaTrainer();
...
public class UserDTO
{
	...
	public UserDTO(string codice_fiscale, string nome, string cognome)
	{
		this.codice_fiscale = codice_fiscale;
		this.nome = nome;
		this.cognome = cognome;
